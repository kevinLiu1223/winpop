    ...
    var HTMLS = {
        ...
        title: '<div class="box_top"><span class="tit"></span><span class="close">close</span></div>'
    }
    ...
    function Winpop() {
        ...
        this.set = function(n, v) {//ovl jQuery("#J_WinpopBox")
            config[n] = v;//config[ovl] = jQuery("#J_WinpopBox")
        }
        this.init();
    }
    console.log("Aa");
    Winpop.prototype = {
        ...
        alert: function(str, btnstr) {//alert方式
            ...
            console.log(HTMLS.alert);
            if (typeof btnstr == "undefined") {
                ovl.find(".J_WinpopBtns").html(HTMLS.alert);
                ovl.find(".J_WinpopMain").append(HTMLS.title);
            } else {
                ovl.find(".J_WinpopBtns").html(btnstr);
            }
            this.show();
        },
        confirm: function(str, callback) {//confirm方式
            var str = typeof str === 'string' ? str : str.toString(),
                ovl = this.get("ovl");
